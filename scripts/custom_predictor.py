...
@Predictor.register("custom_semantic_role_labeling")
class CustomSemanticRoleLabelerPredictor(Predictor):
    """
    ...
    def predict_tokenized(self, tokenized_sentence: List[str], labels: List[str]) -> JsonDict:
        """
