...
print(total_gt_corefs)
print(untag_gt_corefs)
print(untag_gt_corefs / total_gt_corefs)
output = {}
output['total_corefs'] = total_corefs
output['untag_corefs'] = untag_corefs
output['untag_ratio'] = untag_corefs / total_corefs
output['total_gt_corefs'] = total_gt_corefs
output['untag_gt_corefs'] = untag_gt_corefs
output['untag_gt_ratio'] = untag_gt_corefs / total_gt_corefs
